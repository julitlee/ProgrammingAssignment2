...
## This second function is called "cacheSolve". cacheSolve is a function to caculate the inverse matrix object 'x' that was defined in makeCacheMatrix. After the first run, the inverse matrix is pulled from cache and a message "Retrieved from cached data" is returned with the matrix.
